...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>FUIT31_Request_Sales_Manager</fullName>
        <field>IT_Sales_Manager_txt__c</field>
        <formula>CASE(  IT_Sales_Manager__c ,
...
IT_Sales_Manager__c
        ...
        <name>FUIT31_Request_Sales_Manager</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FUIT32_Request_Sales_Manager2</fullName>
        <field>IT_Sales_Manager_txt__c</field>
        <formula>CASE(  IT_Sales_Manager__c ,
&quot;101&quot;,&quot;MERI LOGUERCIO&quot;,
&quot;102&quot;,&quot;LORENZO LOPEZ&quot;,
...
&quot;200&quot;,&quot;RAFFAELLA OPPEDISANO&quot;,
  IT_Sales_Manager__c
        ...
        <name>FUIT32_Request_Sales_Manager2</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FUIT33_Request_Sales_Manager3</fullName>
        <field>IT_Sales_Manager_txt__c</field>
        <formula>CASE( IT_Sales_Manager__c ,
&quot;201&quot;,&quot;ANNA CRUSCO&quot;,
&quot;202&quot;,&quot;LAURA ZACCHETTI&quot;,
...
IT_Sales_Manager__c
        ...
        <name>FUIT33_Request_Sales_Manager3</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FUIT34_Request_Sales_Manager4</fullName>
        <field>IT_Sales_Manager_txt__c</field>
        <formula>CASE(  IT_Sales_Manager__c ,
...
IT_Sales_Manager__c
        ...
        <name>FUIT34_Request_Sales_Manager4</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>FUIT35_Request_Sales_Manager5</fullName>
        <field>IT_Sales_Manager_txt__c</field>
        <formula>CASE(  IT_Sales_Manager__c ,
...
&quot;999&quot;,&quot; In attesa di variazione&quot;,
 IT_Sales_Manager__c 
        ...
        <name>FUIT35_Request_Sales_Manager5</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>WFIT31_Request_Sales_Manager</fullName>
        <actions>
            <name>FUIT31_Request_Sales_Manager</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>value(  IT_Sales_Manager__c  ) &lt;= 100</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WFIT32_Request_Sales_Manager2</fullName>
        <actions>
            <name>FUIT32_Request_Sales_Manager2</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>AND( value(  IT_Sales_Manager__c  ) &lt;= 200, value( IT_Sales_Manager__c ) &gt; 100 )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WFIT33_Request_Sales_Manager3</fullName>
        <actions>
            <name>FUIT33_Request_Sales_Manager3</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>AND( value(  IT_Sales_Manager__c  ) &lt;= 300, value(  IT_Sales_Manager__c ) &gt; 200 )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WFIT34_Request_Sales_Manager4</fullName>
        <actions>
            <name>FUIT34_Request_Sales_Manager4</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>AND( value(  IT_Sales_Manager__c  ) &lt;= 400, value( IT_Sales_Manager__c ) &gt; 300 )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>WFIT35_Request_Sales_Manager5</fullName>
        <actions>
            <name>FUIT35_Request_Sales_Manager5</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <formula>value(  IT_Sales_Manager__c  ) &gt; 400</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
</Workflow>
