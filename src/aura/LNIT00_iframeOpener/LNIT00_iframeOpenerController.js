({
    init : function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
			if (response.getState() == "SUCCESS") {
				...
				console.log ("QUERYSTRING PARSATA??:: "+decodeURI(queryString));
				var workspaceAPI = component.find("workspace");
				component.set("v.isIframe" , isIframe);
                component.set("v.calledSystem" , calledSystem);
				component.set("v.extUrl" , "https://eit-ssobridge-a.edenred.net/"+calledSystem+decodeURI(queryString));
				var icon;
				...
				if (calledSystem == "SGOP" || calledSystem == "SGOC"){
					component.set("v.extUrl", linkList.IT_SgopSgoc__c+calledSystem+decodeURI(queryString));
				}
				...
				workspaceAPI.getTabInfo().then(function(response) {
					...
					if(isIframe ==="false"){
						...
						component.set("v.nextUrl", linkList.IT_SsoBridge__c+queryString); 
    ...
    loadedFrame : function(component, event) {
        ...
        if(component.get("v.logoutHandler") && component.get("v.isIframe")){
            ...
            if(component.get("v.calledSystem") == 'Portale Clienti Elettronico'){
                console.log('ELETTRO');
                component.set("v.logoutHandler" , false);
