trigger TRIT00_DeleteFromZuora on IT_Usage__c (before delete,after delete) {
   ...
   ELSE {
        ...
        APIT00_PostUsage.getToken(NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL, TRUE, idUsage);
    	}
