trigger TRER01_AccountBeforeInsert on Account (before insert) {
    /*
    ----------------------------------------------------------------------
    -- - Name          : TRER01_AccountBeforeInsert
    -- - Author        : AAB
    -- - Description   : Trigger on Account insert (To update the related Client if it exists)
    -- Maintenance History:
    --
    ...
    */
    ...
    if (APER10_User_Management.canTrigger) {
        ...
        System.debug('### TRER01_AccountBeforeInsert Start');
        ...
        */
        System.debug('### TRER01_AccountBeforeInsert End');
    }
}