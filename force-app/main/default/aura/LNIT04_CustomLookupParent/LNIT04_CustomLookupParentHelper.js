({
    doInit: function (component, event, helper) {
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log("CASERECORDTYPEID: " +currentCase.RecordTypeId);
                component.set('v.RecordTypeIdCase' , currentCase.RecordTypeId);
                console.log("CURRENT CASE: " +JSON.stringify(currentCase));
                var selectedCirc = [];
                var selectedacc = [];
                var selectedFin = [];
                ...
                if(currentCase.IT_Circuit__r != null){
                    selectedCirc.push(currentCase.IT_Circuit__r);
    ...
    handleEvent: function (component, event, helper) {
        ...
        if (Object == "Account") {
            ...
            if (lookupEventToParent.IT_Circuit__r) {
